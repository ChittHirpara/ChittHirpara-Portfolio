...
const navLinks = {
    General: ['Home', 'Blogs', 'Guestbook', 'Uses'],
            ...
            <div className="max-w-7xl mx-auto">
                ...
                <div className="relative mb-32">
                    <div className="flex flex-col lg:flex-row items-start lg:items-center justify-between gap-12">
                        ...
                        {/* Right - Glowing Ring with Animated Dash Spacing */}
                        <motion.div
                            initial={{ opacity: 0 }}
                            animate={isInView ? { opacity: 1 } : { opacity: 0 }}
                            transition={{ duration: 1.2, delay: 0.3 }}
                            className="relative w-40 h-40 hidden lg:block"
                        >
                            ...
                            <motion.div
                                ...
                                className="absolute inset-0 rounded-full bg-gradient-to-r from-purple-500/30 via-blue-500/30 to-cyan-500/30 blur-lg"
                            />

                            {/* SVG Ring with animated dash spacing */}
                            ...
                            <style>{`
                                ...
                                @keyframes dashAnimation {
                                    0% { stroke-dasharray: 20 10 5 10; stroke-dashoffset: 0; }
                                    25% { stroke-dasharray: 40 5 20 5; stroke-dashoffset: -70; }
                                    50% { stroke-dasharray: 10 25 10 20; stroke-dashoffset: -140; }
                                    75% { stroke-dasharray: 50 10 5 25; stroke-dashoffset: -210; }
                                    100% { stroke-dasharray: 20 10 5 10; stroke-dashoffset: -283; }
                                }
                            `}</style>
                        </motion.div>
                    </div>
                ...
                >
                    ...
                    <div className="flex flex-col sm:flex-row items-center justify-between gap-6">
                        ...
                        <div className="flex items-center gap-1">
                            <SocialIcon href="https://github.com" delay={0.75}>
                            ...
                            <SocialIcon href="https://linkedin.com" delay={0.8}>
                                <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
                                    <path d="M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433c-1.144 0-2.063-.926-2.063-2.065 0-1.138.92-2.063 2.063-2.063 1.14 0 2.064.925 2.064 2.063 0 1.139-.925 2.065-2.064 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.222 0h.003z" />
                                </svg>
                            </SocialIcon>
                            <SocialIcon href="https://twitter.com" delay={0.85}>
                                <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
                                    <path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z" />
                                </svg>
                            </SocialIcon>
                            <SocialIcon href="https://instagram.com" delay={0.9}>
                                <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
