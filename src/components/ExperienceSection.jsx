...
const experiences = [
    ...
    },
    {
        ...
        highlights: [
            { text: 'Engineered', keyword: 'core application features', rest: ' — improved platform scalability and API performance.' },
            { text: 'Built', keyword: 'responsive user interfaces', rest: ' and backend integrations for seamless user experience.' },
            { text: 'Collaborated on', keyword: 'full-stack solutions', rest: ' across web & mobile platforms.' },
        ],
        skills: ['React', 'Node.js', 'TypeScript', 'Full Stack Development', 'API Design'],
    },
    {
        date: 'PRESENT',
        company: 'Noerax',
        ...
        highlights: [
            { text: 'Leading', keyword: 'software engineering & product architecture', rest: ' at Noerax.' },
            { text: 'Spearheading', keyword: 'next-generation web applications', rest: ' with focus on performance, scalability & UX.' },
            { text: 'Designing', keyword: 'robust cloud infrastructure & modern AI integrations', rest: '.' },
        ],
        skills: ['Lead Engineering', 'System Architecture', 'React / Next.js', 'Node.js', 'Cloud Deployment'],
    },
    {
        date: "WHAT'S NEXT",
        company: 'The Horizon',
