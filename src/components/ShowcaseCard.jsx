            ...
            >
                    ...
                    <div>
                        <div className="flex items-center justify-between mb-3">
                            <div className="flex items-center gap-3">
                                <div className="w-10 h-10 rounded-xl bg-white p-1 flex items-center justify-center shadow-md border border-white/20 group-hover:scale-105 transition-transform flex-shrink-0">
                                    <img
                                        src="https://noerax.com/assets/noerax-logo-CSnbKFv6.png"
                                        alt="Noerax"
                                    ...
                                    />
                                    <span className="hidden text-black font-black text-sm">N</span>
                                </div>
                                <div>
                        ...
                        <p className="text-[11px] text-gray-300 leading-relaxed font-light">
                            Building next-generation digital experiences, intelligent tools, and scalable web solutions.
                        </p>
                    </div>

                    <div className="mt-3 pt-2.5 border-t border-white/10 flex items-center justify-between text-[10px]">
                        <span className="font-mono text-orange-400">noerax.com</span>
                ...
                >
                    <div>
                        <div className="flex items-center justify-between mb-3">
                            <div className="flex items-center gap-3">
                                <div className="w-10 h-10 rounded-xl bg-[#0f172a] p-1.5 flex items-center justify-center shadow-md border border-white/10 group-hover:scale-105 transition-transform flex-shrink-0">
                                    <img
                                        src="https://app.revoot.in/ShortLogo.png"
                                        alt="Revoot"
                                        className="w-full h-full object-contain"
                                        onError={(e) => {
                                            e.target.style.display = 'none'
                    ...
                    <div className="mt-3 pt-2.5 border-t border-white/10 flex items-center justify-between text-[10px] text-gray-500">
                        <span className="font-mono text-gray-400">app.revoot.in</span>
